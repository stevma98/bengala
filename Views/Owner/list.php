												...
												<form>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
															...
															<select name="department" id="department" class="form-control" placeholder="Departamento">
                                                                <option value="blaaa">bla</option>
                                                            </select>
														</div>
														<div class="form-group col-md-6 mb-3 mb-lg-0">
															<label for="city">Ciudad</label>
															<select name="city" id="city" class="form-control">
                                                                <option value="bl">blabla</option>
                                                            </select>
														</div>
													</div>
                                                    <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
														...
														<div class="form-group col-md-6 mb-3 mb-lg-0">
															...
															<input type="text" id="confirmer" value="0">
														</div>
													</div>
												</form>
											</div>
